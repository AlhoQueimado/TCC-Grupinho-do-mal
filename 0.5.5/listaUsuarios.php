...
<div class="conteudo">
  <br><br><br><br>
  <center><h2>Lista de Usuários</h2>
  <a href="?pagina=formUsuario">Cadastrar um Usuário</a></center>
  <br><br><br><br>
  <table class="tabela">
    <tr>
  		<td>ID</td>
    ...
    while($linha = mysqli_fetch_assoc($resultado)) {
  		echo "<tr>";
  		echo "<td>$linha[id_usuario]</td><td>";
  		if($linha[matricula_usuario]){echo "$linha[nome_jogador]";}
  		echo "</td><td>$linha[login_usuario]</td>";
      echo "<td>$linha[email_usuario]</td>";
      echo "<td>$linha[matricula_usuario]</td>";
      echo "<td> <img class='imagem' src='$linha[imagem_usuario]' width='50' height='50' /> </td>";
      echo "<td>";
