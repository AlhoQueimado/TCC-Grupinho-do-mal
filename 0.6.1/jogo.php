  ...
  <form class="" action="fimjogo.php?id_esporte=<?php echo $_GET[id_esporte]?>" method="post">
    ...
    <div class="timeb" style="display: table-cell;">
      ...
      <div class="controlePontuacaoB">
        <a href="#" onclick="aumentarPontuacaoB()" >+</a>
        <div id="pontuacaoB">

        </div>
        <a href="#" onclick="diminuirPontuacaoB()">-</a>
      </div>
...
?>
  <script type="text/javascript">
    document.getElementById('chanceB').innerHTML = "<?php echo "<br>Time B:" .number_format($estimativaB*100)."%<br><br>";?>";
    document.getElementById('chanceA').innerHTML = "<?php echo "<br>Time A:" .number_format($estimativaA*100)."%<br><br>";?>";
  </script>
</div>
</div>
